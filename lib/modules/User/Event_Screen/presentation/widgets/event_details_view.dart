...
class EventDetailsView extends StatelessWidget {
  ...
  final String email;
  const EventDetailsView({super.key, required this.event_id,required this.email});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('event collection').snapshots(),
          ...
          return SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text('${doc['event title']}', style: TTypography.textBlack30,),
                  ...
                  Text('${doc['description']}', style: TTypography.textBlack18,),
                  UIHelpers.verticalSpaceRegular,
                  const Text('Services:', style: TTypography.textBlack22Bold,),
                  UIHelpers.verticalSpaceRegular,
                  Text('${doc['service']}', style: TTypography.textBlack18,),
                  UIHelpers.verticalSpaceRegular,
                  Row(
                    children: [
                      const Text('Price: ', style: TTypography.textBlack22Bold,),
                      Text('${doc['price']}', style: TTypography.textBlack20,)
                    ],
                  ),
                  ...
                  GradientButton(
                    onPressed: () {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(builder: (_)=>ThemeView(eventname: eventname,theme_type: theme_type,email: email,)));
                    },
                    child: const Text('Themes', style: TTypography.textWhite20Bold,)
                  )
                ],
              ),
            ),
